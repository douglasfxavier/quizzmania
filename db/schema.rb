...
ActiveRecord::Schema.define(version: 2019_08_14_234747) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["answers_id"], name: "index_users_on_answers_id"
  end
  ...
  add_foreign_key "users", "answers", column: "answers_id"
end
